...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tv, tvDemo3, tvExercise3, tvDemo4, tvDemo5, tvInput1, tvInput2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvInput1 = findViewById(R.id.textViewInput1);
        tvInput2 = findViewById(R.id.textViewInput2);
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        String number1 = etInput1.getText().toString();
                        String number2 = etInput2.getText().toString();
